...
本项目是 Cocos Creator 2D 微信小游戏，不套用 DOM 默认实现。正式游戏 UI 使用 Cocos Label、Sprite、UITransform 与可访问的微信原生边界能力；只有浏览器设计板或 Web 冒烟才考虑 DOM。任何上游 Web/3D 架构建议都不得覆盖项目根 `AGENTS.md`、`docs/PROJECT-MEMORY.md` 或已批准母版。
...
Use this local prompt shape: `fantasy + viewpoint + player verbs + visible UI layers + motion tone + mobile safe areas + playfield protection + anti-patterns`. For 今夜有灯, also name the current Gate and cite the approved 390×844 mother frame.
...
- Project contract: `../../../AGENTS.md` and `../../../docs/PROJECT-MEMORY.md`
- Project design gate: `../tonight-design-gate/SKILL.md`
- Playtest review: `../game-playtest/SKILL.md`
